...
////////////////////////////////Ready////////////////////////////////////////
client.on('ready', () => {
console.log(`[API] Logged in as ${client.user.username} by Boyka`);
client.user.setStatus(`dnd`)
client.user.setActivity(`By Boyka`)
})
...
client.on("guildMemberAdd", member => {
  ...
  return channel.send(`**__Welcome to Server. We use bot system with many commands__** : **Public Commands, Admin Commands, Economy Commands.**
